...
//
// To change a roster: edit here and push, OR set
...
export const ROSTERS = fromEnv("POOL_ROSTERS") || [
  ...
  { name: "Jordyn Kerr", teams: ["Austria", "Egypt"] }, // was Slovakia (did not qualify) — swapped June 11, 2026
...
export const FORECAST = fromEnv("POOL_FORECAST") || {
  ...
  "Egypt":         { t: "Egypt",         st: "R32", gw: 1, gd: 1, uw: 0 }, // replaced Slovakia (did not qualify)
};
